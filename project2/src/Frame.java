...
public class Frame {
  public String destination_address, data_size, data, priority;
  ...
  public Frame(String destination_address, String data_size, String data, String priority, int source_address){
  ...
  private void create_binary_frame(){
    PPP = fill_bit_string(Integer.toBinaryString(Integer.parseInt(priority)), 3);
    T = "1";
    M = "0";
    RRR = "000";
